...
while True:
    print('\n1.Выровнить по левому краю. ')
    print('2. Выровнить по правому краю.')
    print('3. Выровнить по ширине.')
    print('4. Удаление слова.')
    print('5. Замена одного слова другим во всем тексте.')
    print('6. Замена арифметических выражений.')
    print('7. Найти предложение с максимальным количеством слов, начинающихся на заданную букву.')
